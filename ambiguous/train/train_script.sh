...
# python $HOME/ambiguous-dataset/ambiguous/train/train_MNIST_final_ccvae.py --dataset mnist --conditional --path $SCRATCH/ccvae_mnistV4.pth --vae_path $SCRATCH/vae4.pth --readout_path $SCRATCH/readout4.pth --data_path $HOME/ambiguous-dataset/ambiguous/train/ --generate_amnist --make_train --make_valid --make_test --train_path $SCRATCH/amnistV5/train/ --valid_path $SCRATCH/amnistV5/valid/ --test_path $SCRATCH/amnistV5/test/ --n_iterations 10000
